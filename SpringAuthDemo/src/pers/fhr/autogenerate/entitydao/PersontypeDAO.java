...
import pers.fhr.autogenerate.entity.Persontype;
 ...
 * 
 * @see pers.fhr.autogenerate.entity.Persontype
...
public class PersontypeDAO extends BaseHibernateDAO {
	...
	public Persontype findById(java.lang.Short id) {
		...
		try {
			Persontype instance = (Persontype) getSession().get(
					"pers.fhr.autogenerate.entity.Persontype", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Persontype instance) {
		...
		try {
			List results = getSession().createCriteria("pers.fhr.autogenerate.entity.Persontype")
