 ...
 * 
 * @see pers.fhr.autogenerate.entity.Person
...
public class PersonDAO extends BaseHibernateDAO {
	...
	public Person findById(java.lang.Long id) {
		...
		try {
			Person instance = (Person) getSession().get("pers.fhr.autogenerate.entity.Person", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Person instance) {
		...
		try {
			List results = getSession().createCriteria("pers.fhr.autogenerate.entity.Person")
